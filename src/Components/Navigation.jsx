...
function Navigation(){
  ...
  return (
    ...
    <HeadContent page="TECHATHON " quote="There's nothing I believe in more strongly than getting young people interested in Science and Engineering, for a better Tomorrow." />
    <Techathon />
    </Route>
