...
<div className='techathon-logo-area'>
            <img className="techathon-logo img-fluid" src="images/Techathon-logo.jpg" alt="img" />
        ...
        <div className="event-details">
            <h1>Details</h1>
            <h2>The event "TECH-A-THON" will be a 5-week long event which will mainly consist
of:</h2>
...
<p>The event will consist of 4-rounds:
<ul>
